...
if ($a5.Count -ne 1 -or $a5[0].status -ne 'accepted' -or
    @($gov.adrs | Where-Object { $_.id -notin @('ADR-001','ADR-002','ADR-003','ADR-004','ADR-005','ADR-006','ADR-007','ADR-008','ADR-009','ADR-PRIV-001') -and $_.status -ne 'planned' }).Count -ne 0 -or

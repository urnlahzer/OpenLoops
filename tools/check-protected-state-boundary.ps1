...
Exact @($persistenceFiles) @('Cargo.toml','src/aad.rs','src/anchor.rs','src/digest.rs','src/dpapi.rs','src/dpapi_ffi.rs','src/envelope.rs','src/error.rs','src/ids.rs','src/lib.rs','src/protected_file.rs','src/reservation.rs','src/shared.rs','src/state_root.rs','src/store.rs') 'P0-STATE-CLAIMS-001'
...
if ($workspaceFingerprint -ne '1e79a87e1b65f8620684c736da0b13a3f3bdac3df5585279522ea05318a3cd57') { Fail 'P0-STATE-CLAIMS-001' }

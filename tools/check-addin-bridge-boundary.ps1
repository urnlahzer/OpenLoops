...
if($null-ne$gov){
 $a10=@($gov.adrs|Where-Object{$_.id-eq'ADR-010'});$planned=@($gov.adrs|Where-Object{$_.id-in@('ADR-011','ADR-012','ADR-013')})
 if($a10.Count-ne 1-or$a10[0].status-ne'accepted'-or@($planned|Where-Object{$_.status-ne'planned'}).Count-ne 0){Fail 'P0-BRIDGE-CROSS-CONTRACT-001'}
...
if((NHash $plan)-ne'b311062b77a07e409a56b7689b87d0ec0ef6286807947b34848313337f810871'){Fail 'P0-BRIDGE-INVENTORY-001'}
if((NHash $trace)-ne'83b218f17266362b284326814c4cfc4791cb8a5e7f961f5c0d07517163ad83be'){Fail 'P0-BRIDGE-INVENTORY-001'}

...
Test-ExactSet -Actual $acceptedAdrs -Expected @('ADR-001', 'ADR-002', 'ADR-003', 'ADR-004', 'ADR-005', 'ADR-006', 'ADR-007', 'ADR-008', 'ADR-009', 'ADR-010', 'ADR-011', 'ADR-PRIV-001') -FailureId 'P0-TRACE-001'

...
if((NHash $plan)-ne'bc857151555cf9be61a0e075c40907e5b9750ac62293b9a5bddf13efe6cbe575'){Fail 'P0-DIST-INVENTORY-001'}
if((NHash $trace)-ne'a5dc80035f1e0b447ec1f1c2f2ed3896eb9d433bd87a515a5c473878c3062fea'){Fail 'P0-DIST-INVENTORY-001'}

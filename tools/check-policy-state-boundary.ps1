...
if((Normalized-Hash $specText)-ne'f0428f9c8ac77a14ed645afe7a30cd4b8a3b1e16783c487100c19499b4470ca9'){Fail 'P0-POLICY-INVENTORY-001'}
...
if((Normalized-Hash $traceText)-ne'dad106cd8df478768af02ff3775b077eca92ec118bac632873f4b68b712d9ad8'){Fail 'P0-POLICY-INVENTORY-001'}

...
if((Normalized-Hash $planText)-ne'eda5228cfa8e2228027d419eb4ec1ac5d1ce003777247cc6b5b80be467674bee'){Fail 'P0-POLICY-INVENTORY-001'}
...
if((Normalized-Hash $traceText)-ne'acc01674336de4d3efca3ff3c68289694054eb0f9f64ca6bdbeb5a3e45f2127b'){Fail 'P0-POLICY-INVENTORY-001'}
